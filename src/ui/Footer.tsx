  ...
  return (
    <div className="globalPadding flex w-full flex-col bg-charcoal">
      <div className="mx-auto flex w-full  max-w-custom flex-col items-start justify-between gap-8 pt-3 text-left md:flex-row md:text-center">
        <div className="h-12 w-12 rounded-full bg-lightGrayText">
        ...
        <div className="flex flex-col items-start justify-between gap-1 text-lightOffWhite md:ml-auto">
          ...
          <div className="paragraphFont flex flex-col items-start justify-between gap-3">
            <NavLink to={"#"}>Outfits</NavLink>
            <NavLink to={"#"}>About Us</NavLink>
            <NavLink to={"#"}>Services</NavLink>
          </div>
        </div>
        <div className="flex flex-col items-start justify-between gap-1 text-lightOffWhite md:ml-10 lg:ml-14">
        ...
        <div className="flex flex-col items-start justify-between gap-1 text-lightOffWhite md:ml-10 lg:ml-14">
          ...
          <div className="paragraphFont flex flex-col items-start justify-between gap-[2px]">
